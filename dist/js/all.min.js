...
var livrosModulo=angular.module("livrosModulo",["ngResource","ngRoute","ngStorage","ui.bootstrap"]);livrosModulo.config(["$routeProvider","$sceProvider",function(o,r){r.enabled(!1),o.when("/livros",{templateUrl:"view/livrosGrid.html",controller:"LivrosController"}),o.when("/livroDetalhe/:id",{templateUrl:"view/livrosDetalhe.html",controller:"LivroDetalheController"}),o.when("/favoritos",{templateUrl:"view/livrosFavoritos.html",controller:"LivrosController"}),o.otherwise({redirectTO:"#!/livros"})}]);
livrosModulo.controller("LivrosController",function(o,r,t){o.pesquisaLivros=function(){r.get({q:o.termoPesquisa},function(r){o.listaLivrosResult=r.items,o.totalPesquisa=r.totalItems})},null!=t.favoritos?o.livrosFavoritos=t.favoritos:(t.favoritos=[],o.livrosFavoritos=[]),o.adicionarFavorito=function(o){t.favoritos.push(o)},o.removerLivro=function(r){o.livrosFavoritos.splice(r,1)},o.totalFavoritos=function(r){var i=0;return angular.forEach(o.livrosFavoritos,function(){i=o.livrosFavoritos.length,i=t.favoritos.length}),i},o.filteredTodos=[],o.currentPage=1,o.numPerPage=12,o.maxSize=5,o.$watch("currentPage + numPerPage",function(){var r=(o.currentPage-1)*o.numPerPage,t=r+o.numPerPage;null!=o.listaLivrosResult&&(o.filteredTodos=o.listaLivrosResult.slice(r,t))})});
livrosModulo.controller("LivroDetalheController",function(o,i,r){o.pesquisaLivros=function(){i.get({q:r.id},function(i){o.livro=i.items})},o.pesquisaLivros()});
livrosModulo.factory("livrosServico",function(o){return o("https://www.googleapis.com/books/v1/volumes",{maxResults:"12",jsonpCallbackParam:"callback"},{get:{method:"JSONP"}})});
livrosModulo.filter("formatFilter",function(){return function(r){if(null!==r){for(var n in r)var i=r[n];return i}}});